...
// l'ordre, c'est le resultat obtenu, puis la preuve chiffree, puis l'absence
// de formules creuses, puis ce qui n'appartient qu'a cette personne. La mise
// en page vient loin derriere : elle se remarque, elle ne convainc pas.
//
// "achievements" passe devant "bullets", et c'est le seul poids ou cette
// lecture s'ecarte franchement de l'autre. Un logiciel de tri ne fait aucune
// difference entre "Encadre une equipe de 12" et "Ramene le turnover de 40 a
// 12 %" : les deux portent un chiffre, les deux se rangent. Un humain ne lit
// que la seconde. C'est exactement ce que ces deux notes servent a montrer.
//
...
const POIDS_HUMAIN = {
  achievements: 1.8,     // ce qui a change parce que la personne etait la
