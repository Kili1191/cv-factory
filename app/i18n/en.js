...
const EN_T = {
  ...
  ai_job:"Target role", ai_jph:"e.g. Sales assistant, Delivery driver, Care assistant...",
  ai_name:"Your name", ai_nph:"First name and last name", ai_city:"Your city (opt.)", ai_cph:"e.g. Manchester",
  ...
  mt_no_score:"This ad says too little to score a fit. The two lists below are still exact.",
  mt_cover:"{n} of the {t} phrases this ad uses are in your CV, word for word",
  ...
  mt_seniority:"Level expected, decoded",
  mt_questions:"Likely interview questions",
  mt_gap_title:"Job title",
  mt_gap_says:" : the ad says ",
  mt_gap_yours:", your CV says ",
  mt_gap_close:". Close, but not identical.",
  mt_gap_exact:".",
  mt_gap_renamed:"You already have it, they call it something else.",
  ...
  mt_empty_cv:"Your CV is empty. Paste the ad and Nuvi writes the CV it asks for.",
  mt_offer_label:"Job ad",
  mt_offer_ph:"Paste the whole job ad here:\n- Job title\n- What the role involves\n- Who they are looking for\n- Skills required",
  mt_apply:"Apply this tailored CV",
  mt_choose_t:"Which CV should Nuvi start from?",
  mt_choose_s:"One click. Nuvi reworks it for this ad, in the ad's own words, and puts it on screen. Ctrl+Z brings the previous one back.",
  mt_choose_current:"The CV on screen",
  mt_choose_record:"My whole record",
  ...
  mt_create_running:"Nuvi is writing the CV for this role...",
  ...
  pk_tab_followup:"Follow-up",
  pk_tab_objections:"Their doubts",
  pk_tab_ask:"Your questions",
  ...
  pk_ask_q:"Question",
  pk_nego_range:"Range",
  pk_nego_argument:"Your argument",
  pk_nego_levers:"Levers beyond salary",
  ...
  pl_free_used:"Your three free fits are used.",
  pl_free_left:"{n} free fits left.",
  pl_month:"24 € a month",
  pl_month_s:"Billed monthly, stop any time.",
  pl_quarter:"49 € for three months",
  pl_quarter_s:"16 € a month, the length of a search.",
  pl_take_month:"Take the month",
  pl_take_quarter:"Take three months",
  pl_signin_first:"The plan is tied to your account. Sign in first: it takes one e-mail.",
  pl_signin_btn:"Sign in",
  pl_opening:"Opening the payment page...",
  pl_failed:"The payment page did not open. Try again in a moment.",
  pl_manage:"Manage my subscription",
  pl_choose:"Choose a plan",
  pl_status_month:"Plan active, monthly",
  pl_status_quarter:"Plan active, three months",
  pl_status_free:"Free: {n} of 3 fits left",
  pl_status_visitor:"Sign in for three free fits",
  pl_until:"Paid until {date}. Cancel any time.",
  pl_includes_short:"One plan gives everything. 24 € a month or 49 € for three months.",
  pl_welcome:"Welcome. Your plan is active.",
  pl_signin_needed:"Sign in for three free fits.",
  pl_later:"Later",
};
