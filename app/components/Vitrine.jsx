...
const T = {
  en: {
    ...
    ticker: ["Read whole by the sorting software", "One page", "Your facts, your words", "Free to check", "PDF and Word", "In French and English"],
    ...
    steps: [["Drop your CV", "A PDF, a Word file, a photo of it, or your LinkedIn page. Nuvi reads it in a second, for free, before you decide anything."],
      ["Paste the job ad", "Nuvi rewrites your CV for that job, from what you have already done."],
    ...
    ruleEyebrow: "Our rule", ruleTitle: "Your facts stay your facts.",
    ruleLead: "Ten years stay ten years. A team of twelve stays a team of twelve. Nuvi changes how it is written, so the software finds it. What goes on your CV is yours, and yours to defend in the interview.",
    ...
    after: [["Cover letter", "One click from Download, written from the same CV and the same ad, in the same voice."],
  ...
  fr: {
    ...
    ticker: ["Lu en entier par le logiciel de tri", "Une page", "Tes faits, tes mots", "Verification gratuite", "PDF et Word", "En francais et en anglais"],
    ...
    steps: [["Depose ton CV", "Un PDF, un fichier Word, une photo, ou ta page LinkedIn. Nuvi le lit en une seconde, gratuitement, avant que tu decides quoi que ce soit."],
      ["Colle l'annonce", "Nuvi reecrit ton CV pour ce poste, a partir de ce que tu as deja fait."],
    ...
    ruleEyebrow: "Notre regle", ruleTitle: "Tes faits restent tes faits.",
    ruleLead: "Dix ans restent dix ans. Une equipe de douze reste une equipe de douze. Nuvi change la facon de l'ecrire, pour que le logiciel le trouve. Ce qui figure sur ton CV est a toi, et c'est toi qui le defends en entretien.",
    ...
    after: [["Lettre de motivation", "A un clic de Telecharger, ecrite depuis le meme CV et la meme annonce, sur le meme ton."],
