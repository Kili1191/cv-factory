...
export const DEMO_CV = {
  ...
  experience: [
    { id: 1, title: "Marketing Manager Senior", company: "TechFlow SaaS", period: "2022-Present", location: "Paris",
      bullets: ["Pilotage strategie growth B2B sur 4 marches europeens", "Augmentation MQL +180% en 18 mois (budget 1.2M EUR)", "Equipe de 6 personnes : content, ops, paid, brand"] },
    { id: 2, title: "Content Marketing Lead", company: "DataLab", period: "2019-2022", location: "Paris",
      bullets: ["Strategie editoriale 3 langues, 80 articles par an", "Audience blog x4 en 2 ans (de 25K a 100K visites/mois)", "Lancement podcast B2B, 12K ecoutes par episode"] },
    { id: 3, title: "Marketing Specialist", company: "WebStudio", period: "2016-2019", location: "Lyon",
      bullets: ["Campagnes paid (Google, LinkedIn, Meta) ROAS 4.2x", "Mise en place CRM HubSpot (700 leads / mois)"] }
  ],
  education: [
  ...
  skills: ["Growth marketing", "B2B SaaS", "Content strategy", "HubSpot CRM", "Google Analytics", "SEO/SEM", "Demand generation", "Marketing automation"],
  languages: [{ lang: "Francais", level: "Natif" }, { lang: "Anglais", level: "C1" }, { lang: "Espagnol", level: "B2" }],
...
const STEPS_FR = [
  { id: "welcome", target: null, position: "center", duration: 6500,
    ...
    cta: "C'est parti" },
  { id: "home", target: "home", duration: 5500,
    eyebrow: "Accueil", title: "Ton tableau de bord.",
    text: "Tout ton CV en un coup d'œil. Tes modifications en direct." },
  { id: "coach", target: "coach", duration: 7500,
    eyebrow: "Coach IA", title: "Ton conseiller carrière 24/7.",
  ...
  { id: "edit", target: "edit", hasSubMenu: true, duration: 6500,
    eyebrow: "Éditer", title: "Clique et ça change.",
    text: "Identité, expériences, formation, compétences. Tout se modifie sur place." },
  { id: "target", target: "target", duration: 5500,
    eyebrow: "Match offre", title: "87% de match. Bonne nouvelle.",
    text: "Tes chances avant de postuler. Et les mots-clés à ajouter pour passer à 95%." },
  { id: "pack", target: "pack", duration: 5500,
    eyebrow: "Pack candidature", title: "4 textes. 1 clic.",
    text: "Lettre, message LinkedIn, mail, pitch entretien. Tous cohérents avec l'offre." },
  { id: "audits", target: "audits", hasSubMenu: true, duration: 7000,
    eyebrow: "Score & Audits", title: "75/100 et tu sais quoi faire.",
    text: "Score recruteur, positionnement, vérité, lisser le parcours. L'action numéro 1 te fait gagner 5 points." },
  { id: "cvs", target: "cvs", hasSubMenu: true, duration: 6000,
    eyebrow: "Mes CV", title: "Plusieurs CV pour plusieurs cibles.",
    text: "Liste, versions, comparaison, modèles. Garde toutes tes versions." },
  { id: "design", target: "design", hasSubMenu: true, duration: 6000,
    eyebrow: "Apparence", title: "Design adapté à ton secteur.",
    text: "Personnaliser couleurs et polices. Traduire FR/EN en 1 clic." },
  { id: "tracking", target: "tracking", duration: 5500,
    eyebrow: "Candidatures", title: "Suivi de toutes tes candidatures.",
    text: "Plus jamais « j'ai postulé chez qui déjà ? »." },
  { id: "conclusion", target: null, position: "center", duration: 6500,
    eyebrow: "À toi", title: "À toi de briller.",
  ...
  return (
    <>
      ...
      <div
        style={{
          position: "fixed",
          left: companionPos.x, top: companionPos.y,
          width: COMPANION_SIZE, height: COMPANION_SIZE,
          zIndex: 9002,
      ...
      >
        ...
        <div style={{
          fontFamily: Serif, fontSize: mob ? 18 : 20, fontWeight: 500,
          letterSpacing: "-0.01em", marginBottom: 8, lineHeight: 1.2,
        }}>{step.title}</div>

        <div style={{
          fontSize: mob ? 13 : 14, lineHeight: 1.5,
          color: "var(--nuvi-ink-muted)", marginBottom: 14,
        }}>{step.text}</div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: "var(--nuvi-ink-muted)", fontSize: 12,
          ...
          <button
            onClick={handleNext}
            style={{
              border: "none", background: GradPurple, color: "#fff",
              fontSize: 13, fontFamily: Sans, fontWeight: 600,
              cursor: "pointer", padding: "10px 20px", borderRadius: 999,
        ...
        <div style={{
          height: 3, background: "rgba(91, 61, 245, 0.12)",
          borderRadius: 2, overflow: "hidden",
        }}>
          <div style={{
            height: "100%", width: `${progress}%`,
            background: GradPurple, borderRadius: 2,
