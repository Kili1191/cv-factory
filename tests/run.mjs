...
const SUITES = [
  ...
  ["a LinkedIn profile is a CV", "./a-linkedin-profile-is-a-cv.mjs"],
  ["an old download is read whole", "./an-old-download-is-read-whole.mjs"],
  ...
  ["the replies are counted honestly", "./the-replies-are-counted-honestly.mjs"],
  ...
  ["the CV leaves as Word", "./the-cv-leaves-as-word.mjs"],
  ...
  ["the letter is one click from Download", "./the-letter-is-one-click-from-download.mjs"],
