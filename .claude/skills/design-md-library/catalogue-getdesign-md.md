# Catalogue getdesign.md (index VoltAgent)

Soixante-huit fichiers `DESIGN.md` de marques reelles, recenses par
[VoltAgent/awesome-claude-design](https://github.com/VoltAgent/awesome-claude-design)
(MIT). Les fichiers eux-memes ne sont pas dans ce depot : ils sont heberges sur
getdesign.md, un lien par entree ci-dessous. On telecharge celui dont on a
besoin, au moment ou on en a besoin.

La liste sert d'abord de repere : elle nomme l'atmosphere de chaque systeme en
une ligne, ce qui suffit souvent a choisir avant meme d'ouvrir le fichier.
